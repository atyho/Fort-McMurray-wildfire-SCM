...
plot_gap_nonsevere <- ggplot(data = FM_nonsevere.gap) + 
  ...
  labs(x=NULL, y=NULL) + coord_cartesian(ylim=c(-15.0,15.0)) +
  scale_x_date(date_breaks="1 year", date_labels="%Y") +
  scale_y_continuous(breaks = seq(-15.0, 15.0, by = 5.0)) +
...
cairo_ps(filename = "figures/plot_CRSC_gap_nonsevere.eps", width=3, height=3, pointsize = 12, fallback_resolution = 300)
plot_gap_nonsevere
dev.off()
