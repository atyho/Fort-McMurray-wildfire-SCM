...
cairo_ps(filename = "figures/plot_BCbal_path_severe.eps", width=3, height=3, pointsize = 12, fallback_resolution = 300)
plot_path_severe
dev.off()
...
cairo_ps(filename = "figures/plot_BCbal_path_nonsevere.eps", width=3, height=3, pointsize = 12, fallback_resolution = 300)
plot_path_nonsevere
dev.off()
