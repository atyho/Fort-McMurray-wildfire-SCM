...
data <- read.csv(file = "../../../../sample_aggregate/df_synth.csv", stringsAsFactors = FALSE) %>% 
  ...
  mutate(ln_bc_bal = log(bc_bal),
         ln_cr_score = log(cr_score),
...
model_spec <- function(data_in, treated_id, unit_set, time_range, pre_trt_range){
  dataprep.out <- dataprep(
    ...
    special.predictors = list(
      ...
      list("bc_bal", c(yr14_q1), "mean"),
      list("bc_bal", c(yr14_q2), "mean"),
      list("bc_bal", c(yr14_q3), "mean"),
      list("bc_bal", c(yr14_q4), "mean"),
      list("bc_bal", c(yr15_q1), "mean"),
      list("bc_bal", c(yr15_q2), "mean"),
      list("bc_bal", c(yr15_q3), "mean"),
      list("bc_bal", c(yr15_q4), "mean"),
      list("bc_bal", c(yr16_q1), "mean")
    ),
    dependent = "bc_bal",
