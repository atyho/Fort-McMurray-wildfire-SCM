...
df_acct = sqlContext.read.parquet("/appdata/TU/TU_Official/Account/account_201[0-2]*_parq") \
  ...
  .where("PRODUCT_TYPE LIKE 'BC'").where("Run_date >= DATE('2010-12-01')")
...
df_acct.printSchema()
df_acct.where("Run_date >= DATE('2011-01-01')").write.parquet(path="df_acct_1112.parquet", mode="overwrite")
