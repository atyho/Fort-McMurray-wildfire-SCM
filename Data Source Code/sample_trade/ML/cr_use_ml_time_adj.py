...
#########################################
# Location when mortgage was originated #
#########################################
...
# Merge the mortgage holder's location with the account-level records
...
df_acct = spark.sql("SELECT df_acct.*, \
                      df_loan_origin.fsa_loan AS fsa_ml, df_loan_origin.Encrypted_LDU_loan AS Encrypted_LDU_ml, \
                      df_loan_origin.prov_loan AS prov_ml, \
                      df_loan_origin.distance_min_loan AS distance_min_ml, df_loan_origin.FM_damage_loan AS FM_damage_ml \
                    FROM df_acct \
