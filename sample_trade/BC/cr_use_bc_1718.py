...
df_acct = sqlContext.read.parquet("/appdata/TU/TU_Official/Account/account_201[6-8]*_parq") \
  ...
  .where("PRODUCT_TYPE LIKE 'BC'").where("Run_date >= DATE('2016-12-01')")
...
df_acct.printSchema()
df_acct.where("Run_date >= DATE('2017-01-01')").write.parquet(path="df_acct_1718.parquet", mode="overwrite")
